...
use crate::{domain::{entities::quests::QuestEntity, repositories::quest_viewing::QuestViewingRepository, value_objects::board_checking_filter::BoardCheckingFilter}, infrastructure::postgres::postgres_connection::PgPoolSquad};
...
impl QuestViewingRepository for QuestViewingPostgres {
    ...
    async fn adventurers_counting(&self, quest_id: i32) -> Result<i64> {
        unimplemented!()
    }
}