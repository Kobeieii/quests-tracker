use std::sync::Arc;
use anyhow::Result;
use crate::domain::{repositories::quest_viewing::QuestViewingRepository, value_objects::{board_checking_filter::BoardCheckingFilter, quest_model::QuestModel}};
...
impl<T> QuestViewingUseCase<T> where T: QuestViewingRepository + Send + Sync {
    ...
    pub async fn adventurers_counting(&self, quest_id: i32) -> Result<i64> {
        unimplemented!()
    }
}
